<template>
  <div class="distpicker-address-wrapper" v-show="shoWrap" >
...
export default {
  name: 'v-distpicker',
  props: {
    shoWrap:{ type: Boolean, default: true},
    ...
    addressBottom: { type: String, default: 'address-bottom' },
  },
  data() {
    return {
      tab: 1,
